...
////////////////////////////////////////////////////////////////////////////////////////////////////
int SINGLY_LINEAR_LINKEDLIST::Count()
{
    return iCountNode;
}
...
void SINGLY_LINEAR_LINKEDLIST::InsertFirst(int iNo)
{
    ...
    cout<<"Node with data "<<iNo<<" inserted at the beginning of the singly linear linked list"<<endl;
}
...
void SINGLY_LINEAR_LINKEDLIST::InsertLast(int iNo)
{
    ...
    cout<<"Node with data "<<iNo<<" inserted at the end of the singly linear linked list"<<endl;
}
...
void SINGLY_LINEAR_LINKEDLIST::InsertAtPosition(int iNo,int iPosition)
{
    ...
    cout<<"Node with data "<<iNo<<" inserted at position "<<iPosition<<" in the singly linear linked list"<<endl;
}
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void SINGLY_LINEAR_LINKEDLIST::DeleteFirst()
{
    ...
    else//If linkedlist contains atleast one node
    {
        ...
        cout<<"Node with data "<<ptemp -> iData<<" deleted from the beginning of the singly linear linked list"<<endl;
        free(ptemp);
        ptemp = NULL;
    }
...
//4. Decrement the count of nodes in the linked list by 1.                                        //
////////////////////////////////////////////////////////////////////////////////////////////////////
void SINGLY_LINEAR_LINKEDLIST::DeleteLast()
{
    if((iCountNode == 0) && (pHead == NULL))//If linkedlist is empty
    {
        cout<<"Linkedlist is empty"<<endl;
    ...
    else//If linkedlist contains atleast two node
    {
        ...
        cout<<"Node with data "<<ptemp -> pNext -> iData<<" deleted from the end of the singly linear linked list"<<endl;
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void SINGLY_LINEAR_LINKEDLIST::DeleteAtPosition(int iPosition)
{
    if((iCountNode == 0) && (pHead == NULL))//If linkedlist is empty
    {
        cout<<"Linkedlist is empty"<<endl;
    ...
    else if(iPosition == 1)//If position is 1
    {
        ...
        cout<<"Node with data "<<ptempdelete -> iData<<" deleted from the beginning of the singly linear linked list"<<endl;
...
////////////////////////////////////////////////////////////////////////////////////////////////////
bool SINGLY_LINEAR_LINKEDLIST::Search(int iSearch)
{
    if((iCountNode == 0)  && (pHead == NULL))
    {
        cout<<"Linkedlist is empty"<<endl;
    ...
    while(iPosition <= iCountNode)
    {
        ...
        {
            cout<<"Element "<<iSearch<<" is found at position "<<iPosition<<" in singly linear linked list"<<endl;
            return true;
        }
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void SINGLY_LINEAR_LINKEDLIST::UpdateNoForNo(int iSearch,int iUpdate)
{
    if((iCountNode == 0) && (pHead == NULL))
    {
        cout<<"Linkedlist is empty"<<endl;
    ...
    while(iPosition <= iCountNode)
    {
        ...
        {
            pHead -> iData = iUpdate;
            cout<<"Element "<<iSearch<<" has been updated to "<<iUpdate<<" in singly linear linked list"<<endl;
    ...
    cout<<"Element "<<iSearch<<" not found in singly linear linked list"<<endl;
}
...
void SINGLY_LINEAR_LINKEDLIST::UpdateNoForPosition(int iUpdate,int iPosition)
{
    ...
    while(iCnt <= iCountNode)
    {
        ...
        {
            pHead -> iData = iUpdate;
            cout<<"Element at position "<<iPosition<<" has been updated to "<<iUpdate<<" in singly linear linked list"<<endl;
...
//   list.                                                                                        //
////////////////////////////////////////////////////////////////////////////////////////////////////
void SINGLY_LINEAR_LINKEDLIST::Concat()
{
...
void SINGLY_LINEAR_LINKEDLIST::InsertBefore(int iNo,int iPosition)
{
    ...
    cout<<"Node with data "<<iNo<<" inserted at the position "<<iPosition<<" of the singly linear linked list"<<endl;
}
...
void SINGLY_LINEAR_LINKEDLIST::InsertAfter(int iNo,int iPosition)
{
    ...
    cout<<"Node with data "<<iNo<<" inserted at the position "<<(iPosition + 1)<<" of the singly linear linked list"<<endl;
}
